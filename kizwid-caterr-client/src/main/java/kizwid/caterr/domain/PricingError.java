...
public class PricingError  extends BaseObject implements Identifiable<Long> {
    ...
    @Override
    public Long getId() { return pricingErrorId; }
    public void setId(long pricingErrorId) { this.pricingErrorId = pricingErrorId; }

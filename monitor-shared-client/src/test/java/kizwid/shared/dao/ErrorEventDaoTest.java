...
public class ErrorEventDaoTest extends DatabaseTxTestFixture{
    ...
    public void canSaveAndRetrieve(){
        ...
        ErrorEvent check = errorEventDao.readById(ErrorEvent.class, errorEvent.getErrorEventId());
    ...
    public void canSaveErrors(){
        ...
        ErrorEvent check = errorEventDao.readById(ErrorEvent.class, errorEvent.getErrorEventId());
        assertEquals(errorEvent, check);
        assertEquals(errorEvent.getErrorEventId(), check.getErrorEventId());
        assertEquals(errorEvent.getPricingErrors().size(), check.getPricingErrors().size());
    ...
    public void canLookupByLaunchEventId() {
        ...
        assertEquals(errorEvent.getErrorEventId(), errorEventId);

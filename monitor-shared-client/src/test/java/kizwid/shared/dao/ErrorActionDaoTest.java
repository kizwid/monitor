...
public class ErrorActionDaoTest extends DatabaseTxTestFixture{
    ...
    public void canSaveAndRetrieveErrorAction(){
        ...
        ErrorAction check = errorActionDao.readById(ErrorAction.class, firstErrorAction.getId());
        assertEquals(firstErrorAction, check);
        ...
        assertEquals(2, pricingErrorDao.findUnactioned(filter).size());
        ...
        assertEquals(10, pricingErrorDao.findUnactioned("").size());
        ...
        ErrorAction checkFilter = errorActionDao.readById(ErrorAction.class, filteredAction.getId());
        assertEquals(filteredAction, checkFilter);

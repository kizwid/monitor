...
@ContextConfiguration(locations = {
        "classpath:shared/dao.spring.xml"
        ,"classpath:sqlLoader/sqlLoader.spring.xml"
})
public class DatabaseTxTestFixture extends AbstractTransactionalJUnit4SpringContextTests {

    private final Logger logger = LoggerFactory.getLogger(DatabaseTxTestFixture.class);

    @Resource
    JdbcTemplate jdbcTemplate;
    @Resource DatabaseReleaseDao    databaseReleaseDao;
    @Resource
    SqlLoader sqlLoader;
    ...
    public void createTxnExpectation() throws IOException {
        ...
        assertTrue(databaseReleaseDao.read(DatabaseRelease.class, SimpleCriteria.EMPTY_CRITERIA).size() > 1);
    ...
    ErrorEvent createErrorEvent(String launchEventId, String batchName, String riskGroupName,
    ...
    PricingError createPricingError(String dictionary, String marketData, String split, String errorMessage) {

...
public class ErrorActionDaoImpl extends AbstractGenericDao implements ErrorActionDao {
    ...
    public ErrorActionDaoImpl(JdbcTemplate jdbcTemplate, PricingErrorDao pricingErrorDao) {
        super(jdbcTemplate,
    ...
    public <T> T readById(Class<T> clazz, long id) {
        ...
        attachChildren(Collections.singletonList((ErrorAction) entity));
        return entity;
    }
    ...
    public <T> List<T> read(Class<T> clazz, SimpleCriteria criteria) {
        ...
        attachChildren((List<ErrorAction>) entities);
        return entities;
    }

    @Override
    public void save(Object entity) {
        if (!(entity instanceof ErrorAction)) {
            throw new IllegalArgumentException("entity must be an instancof ErrorAction: " + entity);
        }
        ErrorAction errorAction = (ErrorAction) entity;
        try {

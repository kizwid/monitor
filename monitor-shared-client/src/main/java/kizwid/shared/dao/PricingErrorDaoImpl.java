...
public class PricingErrorDaoImpl extends AbstractGenericDao implements PricingErrorDao {
    ...
    public void save(Object entity) {
        if( !(entity instanceof PricingError)){
            throw new IllegalArgumentException("entity must be an instancof PricingError: " + entity);
        }
        PricingError pricingError = (PricingError)entity;

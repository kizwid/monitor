...
@Entity
@NamedQueries({
        @NamedQuery(name="ErrorEvent.findById", query="from ErrorEvent e where e.errorEventId = :errorEventId")
        ,@NamedQuery(name="ErrorEvent.findByRiskGroup",
        query="from ErrorEvent e where e.riskGroupName = :riskGroupName")
        ,@NamedQuery(name="ErrorEvent.findByRiskGroupBatch",
        query="from ErrorEvent e where e.riskGroupName = :riskGroupName and e.batchName = :batchName")
})
